...
public class QuadHelper {
   ...
   * @param rotation The rotation to apply to the quad.
   * @param sprite The sprite to use.
   * @return A {@link BakedQuad}.
   */
  public static BakedQuad createQuad(Direction face, Transformation rotation, TextureAtlasSprite sprite) {
    return switch(face) {
      case DOWN -> createQuad(v(0, 0, 0), v(1, 0, 0), v(1, 0, 1), v(0, 0, 1), rotation, sprite);
      case UP -> createQuad(v(0, 1, 0), v(0, 1, 1), v(1, 1, 1), v(1, 1, 0), rotation, sprite);
      case NORTH -> createQuad(v(0, 1, 0), v(1, 1, 0), v(1, 0, 0), v(0, 0, 0), rotation, sprite);
      case SOUTH -> createQuad(v(0, 1, 1), v(0, 0, 1), v(1, 0, 1), v(1, 1, 1), rotation, sprite);
      case EAST -> createQuad(v(1, 1, 0), v(1, 1, 1), v(1, 0, 1), v(1, 0, 0), rotation, sprite);
      case WEST -> createQuad(v(0, 1, 0), v(0, 0, 0), v(0, 0, 1), v(0, 1, 1), rotation, sprite);
    };
  }
