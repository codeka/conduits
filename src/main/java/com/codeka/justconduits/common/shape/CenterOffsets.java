...
public class CenterOffsets {
  ...
  private static final Map<Key, List<Vec3>> CENTER_OFFSETS_FOR_DIRECTIONS = ImmutableMap.<Key, List<Vec3>>builder()
      .put(
          ...
          Lists.newArrayList(
              new Vec3(0.25f, 0.75f, 0.5f), new Vec3(0.75f, 0.25f, 0.5f), new Vec3(0.5f, 0.5f, 0.5f),
              new Vec3(0.25f, 0.5f, 0.5f), new Vec3(0.75f, 0.5f, 0.5f), new Vec3(0.5f, 0.75f, 0.5f),
              new Vec3(0.5f, 0.25f, 0.5f), new Vec3(0.75f, 0.75f, 0.5f), new Vec3(0.25f, 0.25f, 0.5f)))
      .put(
          new Key(Direction.EAST),
          Lists.newArrayList(
              new Vec3(0.5f, 0.75f, 0.25f), new Vec3(0.5f, 0.25f, 0.75f), new Vec3(0.5f, 0.5f, 0.5f),
